...
const MentorLayout: React.FC = () => {
  ...
  const navItems = [
    { label: t('dashboard'), path: '/mentor/dashboard' },
    { label: t('availability'), path: '/mentor/availability' },
    { label: t('sessions'), path: '/mentor/sessions' },
    { label: t('profile_settings'), path: '/profile' }
  ]
